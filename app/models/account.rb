...
class Account < ApplicationRecord
  ...
  has_many :bot_flow_executions, dependent: :destroy_async
  ...
  after_update_commit :setup_internal_chat, if: -> { saved_change_to_feature_internal_chat? && feature_internal_chat? }
